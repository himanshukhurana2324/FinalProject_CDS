...
ap = ctrl.Antecedent(np.arange(0.0, 11, 1), 'ap')
an = ctrl.Antecedent(np.arange(0.0, 11, 1), 'an')
da = ctrl.Antecedent(np.arange(0.0, 11, 1), 'da')
vom = ctrl.Antecedent(np.arange(0.0, 11, 1), 'vom')
wl = ctrl.Antecedent(np.arange(0.0, 11, 1), 'wl')
bmi = ctrl.Antecedent(np.arange(0.0, 41, 1), 'bmi')
cd = ctrl.Consequent(np.arange(0.0, 10.01, 1), 'cd')
ap['Mild'] = fuzz.trimf(ap.universe, [0.0, 0.0, 4])
ap['Mod'] = fuzz.trimf(ap.universe, [1, 5, 9])
ap['Sev'] = fuzz.trimf(ap.universe, [6, 10.0, 10.0])
an['Mild'] = fuzz.trimf(an.universe, [0.0, 0.0, 4])
an['Mod'] = fuzz.trimf(an.universe, [1, 5, 9])
an['Sev'] = fuzz.trimf(an.universe, [6, 10.0, 10.0])
da['Mild'] = fuzz.trimf(da.universe, [0.0, 0.0, 4])
da['Mod'] = fuzz.trimf(da.universe, [1, 5, 9])
da['Sev'] = fuzz.trimf(da.universe, [6, 10.0, 10.0])
vom['OnceWeek'] = fuzz.trimf(vom.universe, [0.0, 0.0, 4])
vom['ThriceWeek'] = fuzz.trimf(vom.universe, [1, 5, 9])
vom['Daily'] = fuzz.trimf(vom.universe, [6, 10.0, 10.0])
wl['US'] = fuzz.trimf(wl.universe, [0.0, 0.0, 4])
wl['UL'] = fuzz.trimf(wl.universe, [2, 10.0, 10.0])
bmi['UW'] = fuzz.trimf(bmi.universe, [0.0, 0.0, 22])
bmi['Normal'] = fuzz.trimf(bmi.universe, [15, 22, 29])
bmi['OW'] = fuzz.trimf(bmi.universe, [22, 40.0, 40.0])
cd['NCD'] = fuzz.trimf(cd.universe, [0.0, 0.0, 1])
cd['EL'] = fuzz.trimf(cd.universe, [0.0, 10.0, 20.0])
cd['VVL'] = fuzz.trimf(cd.universe, [10.0, 20.0, 30.0])
cd['VL'] = fuzz.trimf(cd.universe, [20.0, 30.0, 40.0])
cd['L'] = fuzz.trimf(cd.universe, [30.0, 40.0, 50.0])
cd['ML'] = fuzz.trimf(cd.universe, [40.0, 50.0, 60.0])
cd['M'] = fuzz.trimf(cd.universe, [50.0, 60.0, 70.0])
cd['MH'] = fuzz.trimf(cd.universe, [60.0, 70.0, 80.0])
cd['H'] = fuzz.trimf(cd.universe, [70.0, 80.0, 90.0])
cd['VH'] = fuzz.trimf(cd.universe, [80.0, 90.0, 100.0])
cd['VVH'] = fuzz.trimf(cd.universe, [90.0, 100.0, 100.0])
