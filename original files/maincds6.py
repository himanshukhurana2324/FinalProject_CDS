...
def Check():
    flag_chk = 0
    global Abdominal_Pain_var, Abdominal_Pain_entry, Anemia_var, Anemia_entry, Diarrhea_var, Diarrhea_entry,  Vomiting_var, Vomiting_entry, Weight_Loss_var, Weight_Loss_entry
    ...
    try:
        ...
        if Diarrhea_value == '':
            ...
            Diarrhea_error_label = Label(root, fg='red', text='                                                         ', font=("Helvetica", 10)).grid(rowspan=1, row=7, column=3)
            ...
            if  Diarrhea_value < 0:
                ...
                Flag_Diarrhea = 1
        if Flag_Diarrhea == 1:
            Diarrhea_error_label = Label(root, fg='red', text='Please enter (some / valid) value.', font=("Helvetica", 10)).grid(rowspan=1, row=7, column=3)
            flag_chk = 1
    except:
        Diarrhea_error_label = Label(root, fg='red', text='Please enter (some / valid) value.', font=("Helvetica", 10)).grid(rowspan=1, row=7, column=3)
        flag_chk = 1
...
def Result(result):
    ...
    Recommandation_label = Label(result_root, fg='blue', text='Recommendation: ', font=("Helvetica", 15), width=18).grid(
...
def Diarrhea_label_func():
    ...
    Diarrhea_label = Label(Diarrhea_root, text='Diarrhea: One of the basic symptoms of celiac disease as watery-stool (diarrhea). Frequently,\n'
        'all celiac patients own the difficulty of diarrhea after taking gluten in the menu.It takes several\n'
...
def Create_GUI():
    ...
    Diarrhea_button = Button(root, padx=35, pady=10, text='PLOT DIARIHEA', fg='black', command=lambda: Diarrhea_func()).grid(rowspan=1, row=6,column=5)
